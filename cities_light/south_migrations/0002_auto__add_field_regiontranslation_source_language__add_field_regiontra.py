...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cities_light_region_translation', 'source_language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)

        # Adding field 'RegionTranslation.is_auto_translated'
        db.add_column('cities_light_region_translation', 'is_auto_translated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Country.allow_translate'
        db.add_column('cities_light_country', 'allow_translate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'City.allow_translate'
        db.add_column('cities_light_city', 'allow_translate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Region.allow_translate'
        db.add_column('cities_light_region', 'allow_translate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CityTranslation.source_language'
        db.add_column('cities_light_city_translation', 'source_language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)

        # Adding field 'CityTranslation.is_auto_translated'
        db.add_column('cities_light_city_translation', 'is_auto_translated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CountryTranslation.source_language'
        db.add_column('cities_light_country_translation', 'source_language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)

        # Adding field 'CountryTranslation.is_auto_translated'
        db.add_column('cities_light_country_translation', 'is_auto_translated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('cities_light_region_translation', 'source_language')

        # Deleting field 'RegionTranslation.is_auto_translated'
        db.delete_column('cities_light_region_translation', 'is_auto_translated')

        # Deleting field 'Country.allow_translate'
        db.delete_column('cities_light_country', 'allow_translate')

        # Deleting field 'City.allow_translate'
        db.delete_column('cities_light_city', 'allow_translate')

        # Deleting field 'Region.allow_translate'
        db.delete_column('cities_light_region', 'allow_translate')

        # Deleting field 'CityTranslation.source_language'
        db.delete_column('cities_light_city_translation', 'source_language')

        # Deleting field 'CityTranslation.is_auto_translated'
        db.delete_column('cities_light_city_translation', 'is_auto_translated')

        # Deleting field 'CountryTranslation.source_language'
        db.delete_column('cities_light_country_translation', 'source_language')

        # Deleting field 'CountryTranslation.is_auto_translated'
        db.delete_column('cities_light_country_translation', 'is_auto_translated')
    ...
    models = {
        ...
        'cities_light.citytranslation': {
            'Meta': {'unique_together': "(('name', 'language_code', 'master'), ('language_code', 'master'))", 'object_name': 'CityTranslation', 'db_table': "'cities_light_city_translation'", 'index_together': '()'},
        ...
        'cities_light.countrytranslation': {
            'Meta': {'unique_together': "(('name', 'language_code', 'master'), ('language_code', 'master'))", 'object_name': 'CountryTranslation', 'db_table': "'cities_light_country_translation'", 'index_together': '()'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_auto_translated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
        ...
        'cities_light.regiontranslation': {
            'Meta': {'unique_together': "(('name', 'language_code', 'master'), ('language_code', 'master'))", 'object_name': 'RegionTranslation', 'db_table': "'cities_light_region_translation'", 'index_together': '()'},
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_auto_translated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
