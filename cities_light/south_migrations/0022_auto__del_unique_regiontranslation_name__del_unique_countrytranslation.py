...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CountryTranslation', fields ['name']
        db.delete_unique(u'cities_light_country_translation', ['name'])

        # Removing unique constraint on 'RegionTranslation', fields ['name']
        db.delete_unique(u'cities_light_region_translation', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'RegionTranslation', fields ['name']
        db.create_unique(u'cities_light_region_translation', ['name'])

        # Adding unique constraint on 'CountryTranslation', fields ['name']
        db.create_unique(u'cities_light_country_translation', ['name'])
